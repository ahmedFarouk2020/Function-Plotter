...
# Design the GUI
label_info = Label(app.mainWindow,"Plot Polynomial Functions",27,"grey", 'Helvetica 18 bold',"blue")#1
label_info.labelObj.place(x=0,y=0)


label_function = Label(app.mainWindow,"The Function",10,"grey", "Arial","black")#1
label_function.labelObj.place(x=0,y=0+40)
label_minValue = Label(app.mainWindow,"Min Value of X",11,"grey", "Arial","black")#3
label_minValue.labelObj.place(x=0,y=30+40)
label_maxValue = Label(app.mainWindow,"Max Value of X",11,"grey", "Arial","black")#5
